...
public class ShiroConfiguration {
	 ...
	 */
	@Bean
	public WechatModularRealmAuthenticator wechatModularRealmAuthenticator() {
		//自定义身份认证realm控制器
		WechatModularRealmAuthenticator modularRealmAuthenticator = new WechatModularRealmAuthenticator();
		//定义策略为只要有一个realm通过就行
